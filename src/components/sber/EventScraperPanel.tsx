    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4">
        ...
        <ul className="text-sm text-blue-800 space-y-1 ml-7">
          <li>🤖 AI анализирует HTML-код страницы мероприятия</li>
          <li>📅 Извлекает точные даты и время проведения</li>
          <li>📍 Определяет формат (онлайн/оффлайн) и локацию</li>
          <li>🏷️ Подбирает релевантные теги и категорию</li>
          <li>✅ Проверяет актуальность (даты в будущем)</li>
        </ul>
      </div>
    </div>
  );
