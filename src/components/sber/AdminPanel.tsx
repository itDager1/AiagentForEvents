...
export function AdminPanel({ events, user, onBack, userRegistrations: initialRegs, onRegistrationsUpdate, isOpen }: AdminPanelProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onBack}>
      <SheetContent side="top" className="space-y-6 h-[90vh] overflow-y-auto">
        {/* Header with Back Button */}
        <div className="flex items-center gap-4">
          <Button
            onClick={onBack}
            variant="outline"
            className="h-12 px-6 bg-white hover:bg-blue-50 border-2 border-blue-200 hover:border-blue-400 text-blue-700 hover:text-blue-800 font-semibold rounded-xl shadow-sm hover:shadow-md transition-all"
          >
        ...
        <div>
          ...
          <p className="text-gray-600">Управление заявками на мероприятия</p>
        </div>
